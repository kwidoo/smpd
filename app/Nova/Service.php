...
{   
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Mūsu ārsti:','doctors_lv')->onlyOnForms(),
            Text::make('Наши доктора:', 'doctors_ru')->onlyOnForms(),
            Text::make('Darba laiks:', 'time')->onlyOnForms(),
            Text::make('Order:', 'order')->hideFromDetail(),
            BelongsToMany::make('Pakalpojumi', 'services2', 'App\Nova\Services2')->searchable(),
            BelongsToMany::make('Pievieontie Ārsti', 'doctors', 'App\Nova\Doctor')->searchable(),
        ];
    }

  //  public static relatableSerivces2(NovaRequest $request, $query)
    /**
