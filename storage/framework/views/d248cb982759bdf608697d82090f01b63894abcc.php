<?php $__env->startSection('title', 'Pakalpojumi'); ?>
	 ...
	 <div class="d-flex flex-column mt-5">
	 	<div class="col-12 col-sm-8 col-md-6 ml-auto mr-auto">
		 	...
		 	<div class="col text-right mb-5">
				<button type="button" name="submit" class="btn btn-lg btn-primary"><?php echo e(__('Отправить')); ?></button>
			</div>
		</div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Oleg's HD/Users/0p/Documents/dev/Local Server/www/smpd/resources/views/contacts.blade.php ENDPATH**/ ?>