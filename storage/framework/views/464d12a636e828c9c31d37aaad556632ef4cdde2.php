        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-6">
                    <a v-if="'<?php echo e(Nova::name()); ?>'" href="<?php echo e(Config::get('nova.url')); ?>" class="no-underline dim font-bold text-90 mr-6">
...
<?php /**PATH /Volumes/Oleg's HD/Users/0p/Documents/dev/Local Server/www/smpd/packages/nova/src/../resources/views/layout.blade.php ENDPATH**/ ?>